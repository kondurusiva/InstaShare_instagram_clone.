          ...
          <div className="mobile-view">
            ...
            <div className="image-followers-following-posts-container">
              ...
              <div className="desktop">
                ...
                <p className="username-main-desktop" key={userId}>
                  {userId}
                </p>
                <p className="bio-desktop" key={userBio}>
                  {userBio}
                </p>
              </div>
            </div>
            <p className="username-main-mobile" key={userId}>
              {userId}
            </p>
            <p className="bio-mobile" key={userBio}>
              {userBio}
            </p>
          </div>
